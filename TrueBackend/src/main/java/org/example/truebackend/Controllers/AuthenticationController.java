...
public RedirectView emailConfirmation(@RequestParam("token") String confirmationToken){
    try{
      confirmationTokenService.getTokenEntityByConfirmationToken(confirmationToken);
        return new RedirectView("https://66c7397a9d77671e6eca982f--inquisitive-flan-e04f90.netlify.app//FYP%20Project/ConfirmationEmailSucessPage.html");
    }
    catch(Exception e){
        System.out.println(e);
        return new RedirectView("https://66c7397a9d77671e6eca982f--inquisitive-flan-e04f90.netlify.app//FYP%20Project/ErrorPage.html");
        }
