...
// adding system to send mail to the user
        SimpleMailMessage simpleMailMessage = new SimpleMailMessage();
                ...
                simpleMailMessage.setText("To confirm your account, please click here : " + "https://fyp-universtiy-production-d7ce.up.railway.app/api/v1/auth/confirm-account?token="+confirmationToken);
