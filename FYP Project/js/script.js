  ...
  <div>
    ...
    $(".form").on("submit", function (event) {
        ...
        if ($(".form").valid()) {
            ...
            newUserPostRequest("https://fyp-universtiy-production-d7ce.up.railway.app/UserData/PUser1");
    ...
    $(".loginForm").on("submit", function (event) {
        ...
        if ($(".loginForm").valid()) {
            ...
            userLoginRequest(`https://fyp-universtiy-production-d7ce.up.railway.app/UserData/login?email=${userEmail}&password=${userPassword}`);
